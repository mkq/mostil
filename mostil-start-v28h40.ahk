...
hotkey("!^+AppsKey", Mostil.start({
	...
	screens: {
		...
		R: { x: 0, y: 0, w: 5120, h: 2088, split: "h", grid: "5%", snap: ["20%", "80%"], inputs: ["r", "t"], ui: { scale: "30%", x: 1080, y: 450, input: true } },
	},
	commands: [ ;
		{ command: "NOP", input: " `t" }, ;
		...
		{ command: "placeWindow", input: "e", name: "Emacs", run: "C:\cygwin\bin\emacs-w32.exe --geometry=160x61-0+0", criteria: "ahk_exe i)\bemacs-w32\." }, ;
